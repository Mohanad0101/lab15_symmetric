...
- `lab_symmetric_ciphers_full_ru.ipynb` — **полные решения** для преподавателя и самопроверки (не использовать как замену самостоятельной работы, если это требует задание).
